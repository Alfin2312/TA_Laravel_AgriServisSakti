...
=======
                    <a href="/barang/add" class="btn btn-outline-primary" style="float: right"><i class="fa fa-plus"></i></a>
...
<<<<<<< HEAD
                                        ...
                                        <button type="button" class="btn btn-danger" data-toggle="modal"
                                            ...
                                            Delete
=======
                                        <a href="/barang/edit/{{ $data->id_brg }}"  class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                        <button type="button" class="btn btn-danger" data-toggle="modal"
                                            data-target="#delete{{ $data->id_brg }}">
